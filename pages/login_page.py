...
class LoginPage(BasePage):
    ...
    def perform_login(self,login_type='v'):
        ...
        if login_type == 'iu':
            sleep(20)
            return_value= self.d.find_element('id', 'divMessageBarContent').text
        else:
            sleep(10)
            ...
            if login_type == 'ip':
                ...
                sleep(90)
                welcome_text=self.d.find_element('css selector','.herosectionauth h2').text
                return_value = welcome_text  #"SUCCESS"
        self.close_site()
        return return_value